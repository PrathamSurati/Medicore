...
const AddBill = ({ patients, onAddBill, onCancel }) => {
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-content add-bill-form">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              <input 
                ...
                readOnly
              />
              {errors.billNumber && <div className="error-text">{errors.billNumber}</div>}
            </div>
          </div>
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              />
              {errors.billDate && <div className="error-text">{errors.billDate}</div>}
            </div>
              ...
              <div className="item-row" key={index}>
                <div>
                  ...
                  {errors[`itemDescription${index}`] && 
                    <div className="error-text">{errors[`itemDescription${index}`]}</div>
                  }
                </div>
                <div>
                  <input 
                  ...
                  {errors[`itemQuantity${index}`] && 
                    <div className="error-text">{errors[`itemQuantity${index}`]}</div>
                  }
                </div>
                <div>
                  <input 
                  ...
                  {errors[`itemPrice${index}`] && 
                    <div className="error-text">{errors[`itemPrice${index}`]}</div>
                  }
                </div>
          ...
          <div className="bill-summary">
            ...
            <div className="summary-row total-row">
              ...
              <div className="summary-value total-value">₹{calculateTotal().toFixed(2)}</div>
            </div>
          </div>
